...
@Component({
  selector: 'app-mis-pelis',
  templateUrl: './mis-pelis.component.html',
  styleUrls: ['./mis-pelis.component.css']
})

export class MisPelisComponent implements OnInit {
  ...
  BorrarMovieSerie(movie:any){
    ...
    console.log('Movie id: ',movie.idGlobal)
    console.log('UID: ',this.User.uid)
    this._moviesService.deleteMovieSerie(this.User.uid,movie.idGlobal,'movie');
    this.getMyListmovie(this.myMovies, 'movie');
    movie.added=false
